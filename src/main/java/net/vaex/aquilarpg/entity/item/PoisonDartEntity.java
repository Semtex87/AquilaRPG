...
public class PoisonDartEntity extends AbstractArrow {
    private boolean hasImpacted;

    public PoisonDartEntity(EntityType<? extends AbstractArrow> p_36721_, Level p_36722_) {
        super(RPGModEntities.POISON_DART.get(), p_36722_);
    }

    public PoisonDartEntity(EntityType<? extends AbstractArrow> p_36717_, LivingEntity p_36718_, Level p_36719_) {
        super(RPGModEntities.POISON_DART.get(), p_36718_, p_36719_);
    }
        ...
        if (entity.hurt(src, damage)) {
            if (ptarget != null) {
                    ...
                    if (!this.level.isClientSide) {
                        ptarget.addEffect(new MobEffectInstance(MobEffects.POISON, 300, 1), owner);
                        this.level.playSound(null, this.getX(), this.getY(), this.getZ(), RPGSoundEvents.BLEEDING_EFFECT.get(), SoundSource.NEUTRAL,
                                2F, 1F);
                    }
    ...
    protected ItemStack getPickupItem() {
        return new ItemStack(RPGItems.POISON_DART.get());
    }
    ...
    public void tick() {
        ...
        this.level.addParticle(ParticleTypes.WARPED_SPORE, this.xo, this.yo, this.zo, 0.0D, 0.0D, 0.0D);
        super.tick();
